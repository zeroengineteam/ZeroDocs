[ Hierarchies](https://github.com/zeroengineteam/ZeroDocs/blob/master/code_reference/class_reference/Hierarchy.markdown) allows physics to building complicated objects from simpler pieces
